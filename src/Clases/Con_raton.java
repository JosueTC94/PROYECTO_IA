...
public class Con_raton extends JFrame implements ActionListener{
	...
	public Con_raton() {
		...
		ver_camino_minimo.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e1)
			{
				...
				while(!p.empty())
				{
					...
					ImageIcon imagen_tesoro = new ImageIcon(getClass().getResource("/Images/bandera.jpg"));
					ImageIcon imagen_escalada = new ImageIcon(imagen_tesoro.getImage().getScaledInstance(ancho, alto, java.awt.Image.SCALE_FAST));
				
					mCasillas[pos_x_min][pos_y_min].setIcon(imagen_escalada);	
				}
		...
		btnNuevoJuego.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				dispose();
				//Creo una nueva interfaz y una nueva sesion. Modalidad de juego tipo con_raton
				Con_raton nuevo_juego = new Con_raton();
			}
		});
